...
public class ModbusJNI {
    ...
    public static native void readCoils3(long contextPtr, int address, int count, ByteBuffer buffer);
    ...
    public static native void readDiscreteInputs3(long contextPtr, int address, int count, ByteBuffer buffer);
    ...
    public static native void readInputRegisters2(long contextPtr, int address, int count, ShortBuffer buffer);

    public static native void readHoldingRegisters(long contextPtr, int address, int count, short[] buffer);
    public static native void readHoldingRegisters2(long contextPtr, int address, int count, ShortBuffer buffer);
    ...
    public static native void writeCoils4(long contextPtr, int address, int count, ByteBuffer buffer);
    ...
    public static native void writeHoldingRegisters2(long contextPtr, int address, int count, ShortBuffer buffer);
}
